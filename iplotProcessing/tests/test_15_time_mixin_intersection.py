...
class IntersectionTimeAlign(unittest.TestCase):
    def setUp(self) -> None:
        sig1 = Signal()
    ...
    def test_align_1(self):
        time_align(self.signals_set_1, mode=TimeAlignmentMode.INTERSECTION,
    ...
    def test_align_2(self):
        time_align(self.signals_set_2, mode=TimeAlignmentMode.INTERSECTION,
                   kind=InterpolationKind.LINEAR)
